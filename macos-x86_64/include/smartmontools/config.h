...
#define SMARTMONTOOLS_BUILD_HOST "x86_64-apple-darwin17.7.0"

/* smartmontools Configure Arguments */
#define SMARTMONTOOLS_CONFIGURE_ARGS " '--prefix=/vagrant/third-party-prebuilt/macos-x86_64' '--disable-shared' '--enable-static' 'CXX=clang++' 'CXXFLAGS=-I/vagrant/third-party-prebuilt/macos-x86_64/include   -fPIC -DNDEBUG -march=x86-64 -Oz' 'LDFLAGS=-L/vagrant/third-party-prebuilt/macos-x86_64/lib  -mmacosx-version-min=10.13' 'CC=clang' 'CFLAGS=-I/vagrant/third-party-prebuilt/macos-x86_64/include  -mmacosx-version-min=10.13 -fPIC -DNDEBUG -march=x86-64 -Oz' 'PKG_CONFIG_PATH=/vagrant/third-party-prebuilt/macos-x86_64/lib/pkgconfig:'"
